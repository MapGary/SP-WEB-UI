...
//    }
    ...
    public void testReceivingDataForShiftSchemaHour() {
        ...
        new LoginPage(getDriver())
                .loginToApp()
                .chooseIntervalMinutes(60)
                .work();
    }

    @Test
    @Epic("Получение времени загрузки данных агрегата За сутки на вкладке Схема")
    @Severity(SeverityLevel.CRITICAL)
    public void testReceivingDataForShiftSchemaDay() {
    ...
    @Test
    @Epic("Получение времени загрузки данных агрегата За месяц на вкладке Схема")
    @Severity(SeverityLevel.CRITICAL)
    public void testReceivingDataForShiftSchemaMonth() {
    ...
    @Test
    @Epic("Получение времени загрузки данных агрегата За год на вкладке Схема")
    @Severity(SeverityLevel.CRITICAL)
    public void testReceivingDataForShiftSchemaYear() {
    ...
    @Test
    @Epic("Получение времени загрузки данных агрегата За 2017-2025 на вкладке Схема")
    @Severity(SeverityLevel.CRITICAL)
    public void testReceivingDataForShiftSchema2017_2025() {

        new LoginPage(getDriver())
                .loginToApp()
                .chooseInterval2017_2025()
                .work();
    }
